...
class Requests {
  ...
  async getTicketById({
    ...
    try {
      ...
      const response = await fetch(`http://localhost:${this.port}/tickets?method=ticketById&id=${id}`, {
        method: 'GET',
        headers: {
  ...
  async getAllTickets() {
    try {
      ...
      const response = await fetch(`http://localhost:${this.port}/tickets?method=allTickets`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json'
        }
  ...
  async createTicket(ticketData) {
    try {
      ...
      const response = await fetch(`http://localhost:${this.port}/tickets?method=createTicket`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  async changeTicketByaId({
    id,
    ...rest
  }) {
    try {
      // Отправка запроса на сервер для обновления тикета по ID
      const response = await fetch(`http://localhost:${this.port}/tickets?method=updateById&id=${id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  async deleteTicketByaId({
    id
  }) {
    try {
      // Отправка запроса на сервер для удаления тикета по ID
      await fetch(`http://localhost:${this.port}/tickets?method=removeById&id=${id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json'
        }
...
class Ticket {
  ...
  getTicket() {
    ...
    const formatedDateTime = moment_default()(this.data.created).format('DD.MM.YY HH:mm'); // Форматирование даты и времени
